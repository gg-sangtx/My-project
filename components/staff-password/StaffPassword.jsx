...
class StaffPassword extends React.Component {
  ...
  checkUpdatePassword(data) {
    ...
    Staff.actions.checkUpdatePassword.request('', params).then(res => {
  ...
  handleChangePassword(e) {
    ...
    if(this.state.password != '' && this.state.password.length < 8) {
      ...
      Staff.actions.createPassword.request('', params).then(res => {
  ...
  render() {
    return (
      <div className='password-container'>
        <h1 className='header-title'>Studio Marl Marl for カメラマン/ヘアメイク</h1>
...
StaffPassword.defaultProps={
  validators: {
    form: []
  }
}

export default withRouter(StaffPassword);