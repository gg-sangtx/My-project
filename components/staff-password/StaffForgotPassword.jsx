...
class StaffForgotPassword extends React.Component {
  ...
  handleSendPassword(e) {
    ...
    if(this.checkEmail()) {
      ...
      Staff.actions.resetPassword.request('',params).then(res => {
...
export default connect()(withRouter(StaffForgotPassword));
